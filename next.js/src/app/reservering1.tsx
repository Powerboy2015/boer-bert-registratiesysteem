          ...
          <section className=" gap-6 p-6 items-center w-full h-100 bg-cover bg-center bg-fixed bg-black/50 bg-blend-multiply" /*yuhh de background staat stil hehe */
            ...
            <div>
              <div className="mt-50 flex flex-row justify-center">
                ...
                <select className="text-center px-10 py-7 my-auto bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border rounded-l-[50]">
                  <option value="">Kies plek grootte</option>
                  <option value="wawa">Grote plek</option>
                  <option value="wowo">Kleine plek</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 justify-items-center gap-1 mt-20">
                  ...
                  <div className="">
                    <div className="relative bg-[#FFFFFF] h-90 w-120 rounded-xl shadow-xl overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-2xl m-12 mt-6" style={{fontFamily:'Roboto mono'}}>Er worden verschillende evenementen zoals boogschieten georganiseerd op de camping.</p>
                      </div>
                    </div>
                  </div> {/*box evenementen */}
                  ...
                  <div className="">
                    <div className="relative bg-[#FFFFFF] h-90 w-120 rounded-xl shadow-xl overflow-hidden">
                      ...
                      <div className="p-6">
                        <p className="text-2xl m-12 mt-6" style={{fontFamily:'Roboto mono'}}>Op de camping zijn er toiletten en douches. Daarnaast is er bij de ingang een parkeerplaats.</p>
                      </div>
                    </div>
