...
export default function Reservering1() {
  ...
  async function fetchAPI() {
    const url = `http://localhost:80/api/public/beschikbaarheid?DatumAankomst=${DatumAankomst}&DatumVertrek=${DatumVertrek}`
            ...
            <section className=" gap-6 p-6 items-center w-full h-100 bg-cover bg-center bg-fixed bg-black/50 bg-blend-multiply" /*yuhh de background staat stil hehe */
              ...
              <div>
                <div className="mt-50 flex flex-row justify-center">
                  ...
                  <select onChange={(e) => setPlaats(e.target.value)} className="text-center px-10 py-7 my-auto bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border rounded-l-[50]">
                    <option value="">Kies een plek</option>
                    <option value="Groot">Groot</option>
                    <option value="Klein">Klein</option>
                  </select>

                  <select onChange={(e) => setPersonen(e.target.value)} className="text-center px-10 py-7 my-auto bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border">
                    <option value="">Aantal personen</option>
                    <option value="wawa">1</option>
                    <option value="wowo">2</option>
                    <option value="wewe">3</option>
                    <option value="wiwi">4</option>
                    <option value="wawa">5</option>
                  ...
                  <div className="flex flex-row text-center px-10 py-7 bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border my-auto">
                    <input onChange={(e) => setDatumAankomst(e.currentTarget.value)} type="date"></input>
                    <p className="mx-7 font-bold">tot</p>
                    <input onChange={(e) => setDatumVertrek(e.currentTarget.value)} type="date"></input>
                  </div>


                  <button onClick={() => fetchAPI()} className="text-center px-15 py-[30px] my-auto bg-[#007248] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#FFFFFF] rounded-r-[50]">Boeken</button>
