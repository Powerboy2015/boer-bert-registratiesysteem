...
import boerbert2 from "./images/boerbert2.jpg";
import boerderij from "./images/boerderij.jpeg";
import camping5 from "./images/camping5.jpg";
import camping6 from "./images/camping6.jpg";
import campinggestolen from "./images/campinggestolen.jpg";
import w3c from "./images/w3c.jpg";
import React from "react";
import Scrollcontact from "./contact";
      ...
      <div className="min-h-screen w-full text-[#2c2c2c] font-sans">
        <header className="shadow-xl w-full flex items-center h-auto justify-between p-4 bg-[#93DAB8] relative sticky top-0 z-50">
          <div className="flex items-center gap-3">
            <a href="http://localhost:3000/" title="knop naar home page">
              ...
              >
                <div className="shadow-xl/30 bg-[#007248] max-width-[300px] rounded-[50%] h-75 w-130">
                  <div className="pl-40 pt-10 bg-[#FDF5D8] max-width-[200px] rounded-[50%] h-67 w-125">
                    <Image
        ...
        <div className="bg-[#007248]">
          <div className="rounded-bl-[500px] overflow-hidden bg-[#007248]">
            <section
              className=" gap-6 p-6 items-center w-full h-215 bg-cover bg-center bg-fixed bg-black/50 bg-blend-multiply" /*yuhh de background staat stil hehe */
              style={{ backgroundImage: "url('/campinggestolen.jpg')" }}
            >
              <div className=" gap-20 p-6 h-250 flex flex-col items-center">
                <h1 className="text-center font-bold pt-50 text-6xl opacity-100 p-5 text-[#fdf5d8]">
                ...
                <a
                  ...
                  target="_blank"
                >
                  <button className="text-center px-15 py-7 bg-[#FDF5D8] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] rounded-xl">
                    Reserveer nu
                  </button>
                </a>
        ...
        {/*sectie die je ziet als je op de pagina komt */}
        <div className="bg-[#FDF5D8]">
          <div className="rounded-bl-[500px] rounded-bl-lg-[500px] overflow-hidden">
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 h-250 items-center bg-[#007248] text-[#FDF5D8]">
              <div className="overflow-hidden w-200 h-200 mx-auto flex-top content-center w-160">
                <div className="bg-[#FDF5D8] ml-10 max-width-[600px] rounded-[50%] h-108 w-180">
                  <div>
                    <Image
                      alt="boerbert"
                      className="shadow-xl/30 max-width-[700px] pt-8 rounded-[50%]"
                      src={boerbert2}
                      width={700}
                      height={700}
                    />
              ...
              <div className="flex-top content-center w-160">
                <h2 className="font-bold mb-4 text-4xl items-center text-center">
                  Wie zijn wij?
                </h2>
                <p
                  className="text-2xl text-justify w-auto place-self-strech"
                  style={{
                    fontFamily: "Roboto mono",
                  }}
                >
                  Wij hebben onze boerderij omgetoverd tot een camping. Op dit
                  moment is dit een groot grasveld met allen plaatsen voor het
                  opzetten van tenten. In de toekomst willen we de camping
                  misschien ook toegankelijk maken voor campers en caravans.
                </p>
              </div>
        ...
        <div className="bg-[#007248]">
          <div
            className="rounded-tr-[500px] h-250 items-center bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply"
            style={{ backgroundImage: "url('/campinggestolen.jpg')" }}
          >
            <div className=" rounded-tr-[500px] rounded-bl-[500px] overflow-hidden">
              <section className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 h-250 gap-6 p-6 items-center bg-[#FDF5D8]">
                <div className="w-80 h-80 mx-auto w-160">
                  ...
                  <p
                    className="text-justify text-2xl w-auto"
                    style={{
                      fontFamily: "Roboto mono",
                    }}
                  >
                    De camping van boer Bert is gebouwd in het jaar 1815 en word
                    al sinds het begin van generatie tot generatie beheert en
                    onderhouden door de familie van boer Bert. Ooit was het een
                    groothandelaar in koeienmelk, maar nu is het doeleind van de
                    boerderij dus veranderd naar een camping vanwege de strenge
                    stikstof wetgevingen.
                  </p>
                </div>
                <div className="overflow-hidden ml-2 w-200 h-200 mx-auto flex-top content-center w-160">
                  {/*stukje text van de geschiedenis van de camping/boerderij */}

                  <div className="bg-[#007248] max-width-[600px] rounded-[50%] h-108 w-190">
                    <div>
                      <Image
                        alt="boerbert"
                        className="shadow-xl/30 max-width-[700px] ml-6 pt-8 rounded-[50%]"
                        src={boerderij}
                        width={750}
                        height={750}
                      />
        ...
        <div className="bg-[#FDF5D8]">
          <div className="rounded-tr-[500px] rounded-bl-[500px] overflow-hidden">
            <section
              className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 h-220 gap-6 p-6 items-center bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply"
              style={{ backgroundImage: "url('/campinggestolen.jpg')" }}
            >
              <div className="w-80 h-80 flex gap-6 mx-auto w-160">
                ...
                <div className="bg-[#f7f0cf] w-90 rounded-xl shadow-lg overflow-hidden">
                  ...
                  <div className="p-6">{/*emptyyyyyy */}</div>
                </div>{" "}
                {/*box voor reservering info voor grote plaatsen */}
              </div>{" "}
              {/*div voor de info boxen */}
              <div className="text-center flex flex-col items-center gap-10 pr-20">
                <h2
                  className="text-[#FDF5D8] text-3xl md:text-4xl font-bold leading-snug"
                  style={{ fontFamily: "Roboto Mono" }}
                >
                  KAMPEER OP JOUW MANIER – ALLEEN <br /> OF SAMEN
                </h2>
                <button className="px-10 py-5 bg-[#FDF5D8] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] rounded-xl">
                  Reserveer nu
                </button>
              </div>
            </section>
        ...
        {/*section voor reservering info en knop naar reservering */}
        <div className="bg-[#FDF5D8]">
          <div
            className="h-300 items-center bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply"
            style={{ backgroundImage: "url('/campinggestolen.jpg')" }}
          >
            <div className="rounded-tr-[500px] overflow-hidden">
              <section className=" gap-6 p-6 h-300 gap-6 p-6 items-center bg-[#FDF5D8]">
                <div className="justify-items-stretch gap-4 items-center">
                  <div className=" text-center h-50 text-6xl text-[#007248] font-bold mt-20 mr-25">
                    Nieuws
                  </div>
                  {/*text: 'Nieuws'.... woah */}
                  <div className="grid grid-cols-1 md:grid-cols-3 justify-items-center gap-0 mr-25">
                    <div className="bg-[#007248] w-100 h-100 text-center rounded-xl shadow-xl overflow-hidden flex flex-col items-center justify-center">
                      <p
                        className="text-3xl text-[#FDF5D8] w-auto m-10"
                        style={{ fontFamily: "Roboto mono" }}
                      >
                        “Ons ultieme doel is om iedereen het boerenleven te
                        laten proeven”
                      </p>
                      <p className="text-4xl text-[#FDF5D8] font-bold w-auto m-5">
                        - Boer bert
                      </p>
                    </div>{" "}
                    {/*groene box met text */}
                    <div className="">
                      <div className="relative bg-white h-150 w-90 rounded-xl shadow-xl overflow-hidden">
                        <div
                          className="bg-[#0A6A3B] h-50 text-[#FDF5D8] p-4 text-xl font-bold bg-black/30 bg-blend-multiply"
                        ...
                        <div className="p-6">
                          <p
                            className="text-xl text-justify m-2"
                            style={{ fontFamily: "Roboto mono" }}
                          >
                        ...
                        >
                          <button className="absolute left-4 bottom-4 px-6 py-2 bg-[#007248] hover:bg-[#008f58] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-2xl font-semibold text-[#FDF5D8] rounded-xl">
                            Lees meer
                          </button>
                        </a>
                      </div>
                    </div>{" "}
                    {/*middelste mox met evenementen */}
                    <div className="">
                      <div className="relative bg-white h-150 w-90 rounded-xl shadow-xl overflow-hidden">
                        <div
                          className=" bg-[#0A6A3B] h-50 text-[#FDF5D8] p-4 text-xl font-bold bg-black/30 bg-blend-multiply"
                  ...
                  {/*div voor alle boxen met info in een column */}
                </div>
              </section>
            </div>
          </div>
        </div>{" "}
        {/*section met nieuws en andere onzin */}
        <footer
