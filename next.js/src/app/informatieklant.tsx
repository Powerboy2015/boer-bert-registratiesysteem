...
export default function Reservering2() {
  ...
  const naamChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
  const achternaamChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
  const adresChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
  const telefoonChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
  const plaatsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
  const emailChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
  const postcodeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setText(e.target.value); /*zegt zovan yuh, de waarde van het input veld in de text variable moet dit zijn nzo :P*/
  }
              ...
              <div className="gap-8 items-center justify-center flex flex-col lg:flex-row">
                ...
                <div className="-translate-y-1/2 z-40">
                  <div className=" bg-[#FFFFFF] rounded-xl shadow-xl overflow-hidden w-250 h-170">
                    ...
                    <div className="flex flex-col p-6 text-center text-justify text-lg font-medium my-auto mx-auto items-center" style={{ fontFamily: "Roboto mono" }}>
                      
                        <div className="text-xl flex flex-col" style={{ fontFamily: "Roboto mono" }}>
                          Voornaam:
                          <div className="mt-3">
                            <input
                              list="Naam klant"
                        ...
                        <div className="text-xl mt-5" style={{ fontFamily: "Roboto mono" }}>
                          Achternaam:
                          <div className="mt-3">
                            <input
                              list="achternaam klant"
                              onChange={achternaamChange}
                              onKeyDown={handleKeyDown}
                              style={{
                              backgroundColor: "#FFFFFF",   
                              color: "#595959ff",
                    ...
                    <div className="flex flex-row justify-center text-justify gap-5 text-lg font-medium my-auto mx-auto items-center">
                        ...
                        <div className="text-xl" style={{ fontFamily: "Roboto mono" }}>
                          Postcode:
                          <div className="mt-3">
                            <input
                              list="Telefoon klant"
                              onChange={telefoonChange}
                              onKeyDown={handleKeyDown}
                              style={{
                              backgroundColor: "#FFFFFF",   
                              color: "#595959ff",
                        ...
                        <div className="text-xl mt-" style={{ fontFamily: "Roboto mono" }}>
                          plaats:
                          <div className="mt-3">
                            <input
                              list="Plaats klant"
                              onChange={plaatsChange}
                              onKeyDown={handleKeyDown}
                              style={{
                              backgroundColor: "#FFFFFF",   
                              color: "#595959ff",
                    ...
                    <div className="flex mx-auto my-auto items-center">
                      ...
                      <div className="my-auto mx-auto items-center text-center p-1 ">
                        <a href="/annuleren"
                          ...
                          <button className="text-center px-20 py-3 bg-[#007248] hover:bg-[#008f58] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#FDF5D8] rounded-xl"
