            ...
            <div>
              <div className="mt-50 flex flex-row justify-center">
                <a href="https://theuselessweb.com/"
                  ...
                  target="_blank">
                <button className="text-center px-15 py-7 bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border rounded-l-[50]">Kies een plek</button>
                </a>
                <a href="https://theuselessweb.com/"
                  title="knop naar reserverings pagina"
                  target="_blank">
                <button className="text-center px-15 py-7 bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border">Aantal personen</button>
                </a>
                <a href="https://theuselessweb.com/"
                  title="knop naar reserverings pagina"
                  target="_blank">
                <button className="text-center px-15 py-7 bg-[#FFFFFF] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#007248] border">Aankomst - Vertrek</button>
                </a>
                <a href="https://theuselessweb.com/"
                  title="knop naar reserverings pagina"
                  target="_blank">
                <button className="text-center px-15 py-7 bg-[#007248] hover:bg-[#a4debc] hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.4)] transition-colors duration-100 text-3xl font-semibold text-[#FFFFFF] rounded-r-[50]">Boeken</button>
                </a>
