    ...
    <section className="bg-[#007248]">
        <div
            className="min-h-screen flex flex-col justify-center items-center text-center
             bg-fixed bg-black/60 bg-blend-multiply bg-cover bg-center
...
<section className="bg-[#007248]">
    <div style={{ backgroundImage: `url(${camping8.src})` }} className="bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply rounded-tr-[180px] xl:rounded-tr-[240px] 2xl:rounded-tr-[500px] overflow-hidden">
