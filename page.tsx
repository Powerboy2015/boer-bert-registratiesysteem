...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen w-full text-[#2c2c2c] font-sans">
      ...
      <div className="bg-[#007248]">
        <div className="rounded-tr-[500px] h-250 items-center bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply"
            style={{ backgroundImage: "url('/campinggestolen.jpg')" }}>
      ...
      <div className="bg-[#FDF5D8]">
        <div className="rounded-tr-[500px] rounded-bl-[500px] overflow-hidden">
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 h-220 gap-6 p-6 items-center bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply"
                  style={{ backgroundImage: "url('/campinggestolen.jpg')" }}>
      ...
      <div className="bg-[#FDF5D8]">
        <div className="h-300 items-center bg-cover bg-center bg-fixed bg-black/60 bg-blend-multiply"
            style={{ backgroundImage: "url('/campinggestolen.jpg')" }}>
